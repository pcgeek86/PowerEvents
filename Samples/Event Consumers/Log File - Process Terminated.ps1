...
New-WmiEventConsumer -ConsumerType LogFile -Name ProcessStoppedLogFile -FileName $env:windir\temp\Process.log `
	-Text "Process has exited. Process name is: %TargetInstance.Name%"