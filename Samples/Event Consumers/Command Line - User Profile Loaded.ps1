...
New-WmiEventConsumer -Verbose -Name UserProfileLoaded -ConsumerType CommandLine -CommandLineTemplate "cscript.exe `"${ScriptPath}\VBscripts\User Profile Loaded.vbs`" `"%TargetInstance.Path%`""
