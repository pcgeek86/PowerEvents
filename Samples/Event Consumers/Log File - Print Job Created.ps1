...
New-WmiEventConsumer -ConsumerType LogFile -Name PrintJobCreated -FileName $env:windir\temp\PrintJobs.log `
	-Text "Print job has been created. Document is: %TargetInstance.Document%"