...
#    Date: 11/28/10
#   Brief: This example shows how to use PowerEvents to create a WMI event filter that detects the deletion of a user object in Active Directory (AD).
...
New-WmiEventFilter -EventNamespace root\directory\ldap -Name ADUserDeleted `
	-Query "select * from __InstanceDeletionEvent within 5 where TargetInstance ISA 'ds_user'"