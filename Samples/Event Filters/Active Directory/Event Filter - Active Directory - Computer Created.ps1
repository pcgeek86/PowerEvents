...
#    Date: 11/28/10
#   Brief: This example shows how to use PowerEvents to create a WMI event filter that detects the creation of a computer object in Active Directory (AD).
...
New-WmiEventFilter -EventNamespace root\directory\ldap -Name ADComputerCreated `
	-Query "select * from __InstanceCreationEvent within 5 where TargetInstance ISA 'ds_computer'"