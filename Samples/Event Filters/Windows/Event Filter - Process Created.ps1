...
#    Date: 11/22/10
#   Brief: This example shows how to use PowerEvents to create a WMI event filter that detects the creation of a Windows process.
...
New-WmiEventFilter -Name ProcessStarted -Query "select * from __InstanceCreationEvent within 2 where TargetInstance ISA 'Win32_Process'"