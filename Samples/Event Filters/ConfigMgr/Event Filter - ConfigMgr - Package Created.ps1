...
#    Date: 11/22/10
#   Brief: This example shows how to use PowerEvents to create a WMI event filter that detects the creation of a new System Center Configuration Mananger (ConfigMgr) package.
...
New-WmiEventFilter -Name ConfigMgrPackageCreated -EventNamespace root\sms\site_lab -Query "select * from __InstanceCreationEvent within 2 where TargetInstance ISA 'SMS_Package'"