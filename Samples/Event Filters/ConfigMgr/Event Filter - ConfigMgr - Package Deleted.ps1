...
#    Date: 11/22/10
#   Brief: This example shows how to use PowerEvents to create a WMI event filter that detects the deletion of a System Center Configuration Mananger (ConfigMgr) package.
...
New-WmiEventFilter -Name ConfigMgrPackageDeleted -EventNamespace root\sms\site_lab -Query "select * from __InstanceDeletionEvent within 2 where TargetInstance ISA 'SMS_Package'"